...
Usage:
    python expo_pi0/data/regenerate_libero_dataset.py \
    ...
    Example (LIBERO-Spatial):
        python expo_pi0/data/regenerate_libero_dataset.py \
            ...
            --libero_raw_data_dir ./datasets/libero/libero_spatial \
            --libero_target_dir ./datasets/libero/libero_spatial_no_noops
...
def main(args):
    ...
    metainfo_json_dict = {}
    metainfo_json_out_path = f"./datasets/{args.libero_task_suite}_metainfo.json"
